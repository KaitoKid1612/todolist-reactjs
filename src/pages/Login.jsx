        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <a  className="cursor-pointer inline-block align-baseline font-normal text-sm text-blue-500 hover:text-blue-800">
                Sign Up
              </a>
            </div>
          </div>
          <p className="text-center text-gray-500 text-xs">©2024 Notez. All rights reserved.</p>
        </div>
      </div>
    )
}
